...
def create_app() -> FastAPI:
    ...
    # More routers are mounted here as they are implemented (checkout, webhooks) — every
    # span they open carries run_id, per DESIGN.md: "run_id ... is on every agent span".
